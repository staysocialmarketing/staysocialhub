...
export const emailPreviewClients: Record<string, EmailPreviewClient> = {
  ...
  "388b23ba-9e74-4c0a-b8a9-5840845c81fe": {
    ...
    templates: [
      {
        label: "The Fuse Brief — Monthly Newsletter",
        description: "Rate snapshot, market update, featured topic, Q&A, personal note. Link to rates on lesleysmortgages.com.",
        file: "newsletter-july.html",
        type: "newsletter",
      },
      {
        label: "BoC Rate Decision — Hold",
        description: "Same-day reaction template for BoC hold scenarios. Decision banner, practical breakdown, Lesley's take.",
        file: "boc-rate-decision-hold.html",
        type: "boc",
      },
      {
        label: "BoC Rate Decision — Cut",
        description: "Same-day reaction template for BoC rate cut scenarios. Updated rate, what it means for buyers and renewals.",
        file: "boc-rate-decision-cut.html",
        type: "boc",
      },
      {
        label: "July Campaign — Renewal Reality Check",
        description: "What your renewal letter isn't telling you. Three questions format, Shameeza spotlight.",
        file: "july-campaign-1-renewal.html",
        type: "campaign",
      },
      {
        label: "July Campaign — BoC Reaction",
        description: "Bank of Canada rate decision breakdown for buyers, renewals, and variable-rate holders.",
        file: "july-campaign-2-boc.html",
        type: "campaign",
      },
      {
        label: "August Campaign — Co-Buying Guide",
        description: "Two names on one mortgage. Who qualifies, exit strategies, co-ownership agreements.",
        file: "august-campaign-1-cobuy.html",
        type: "campaign",
      },
      {
        label: "August Campaign — Self-Employed Guide",
        description: "Your income is real. What lenders need, how to prepare, why a broker matters.",
        file: "august-campaign-2-selfemployed.html",
        type: "campaign",
      },
      {
        label: "Introduction Email",
        description: "Welcome email for new clients and referral partners.",
        file: "intro-email.html",
        type: "announcement",
      },
    ],
  },
