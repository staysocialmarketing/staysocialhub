...
--
-- Conditional: skips silently on fresh branch environments where the user
-- does not yet exist (branch previews, CI). Runs fully on production.
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM auth.users WHERE id = '6d0174a4-110e-4867-897d-f89a3729f7d2') THEN
